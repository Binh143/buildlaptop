...
export class ContentProductDetailt extends Component {
            ...
            <div className="row">
              <div className="col-sm-7 white sm-padding">
                ...
                <p>
                  ...
                  your work. Surface Studio is designed with a Zero Gravity
                  Hinge that moves the display weightlessly from an upright
                  angle, down into Studio Mode with one hand.
                </p>
                <br />
                ...
                <div className="row specification">
                  ...
                  <div className="col-sm-8">
                    {" "}
                    <p>
                      Rapid hybrid drive options: 64GB SSD with 1TB HDD, 128GB
                      SSD with 1TB HDD, 128GB SSD with 2TB HDD
                    </p>{" "}
                  </div>
                </div>
                <div className="row specification">
                  ...
                  <div className="wrapper">
                    <div className="content">
                      ...
                      <p>
                        ...
                        examine the service's features, UK pricing, audio
...
export default ContentProductDetailt;
